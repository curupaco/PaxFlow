...
class App {
  ...
  private setupNavigationListeners(): void {
    const pages = ['analytics', 'inbox', 'orcamentos', 'dashboard', 'clientes', 'reembolsos', 'configuracoes', 'cadastros'];
  ...
  private navigate(page: string, extraId?: string): void {
    ...
    const navButtons = ['analytics', 'inbox', 'orcamentos', 'dashboard', 'clientes', 'reembolsos', 'configuracoes', 'cadastros'];
