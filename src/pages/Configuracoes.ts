    ...
    try {
      ...
      if (data) {
        this.settings = {
          ...
          antecedencia_risco_operacional_dias: data.antecedencia_risco_operacional_dias !== undefined ? data.antecedencia_risco_operacional_dias : 15,
          antecedenciaRiscoOperacionalDias: data.antecedencia_risco_operacional_dias !== undefined ? data.antecedencia_risco_operacional_dias : 15,
          habilitar_risk_score: data.habilitar_risk_score !== false,
          habilitarRiskScore: data.habilitar_risk_score !== false,
          risk_score_janela_carencia_dias: data.risk_score_janela_carencia_dias !== undefined ? data.risk_score_janela_carencia_dias : 60,
          riskScoreJanelaCarenciaDias: data.risk_score_janela_carencia_dias !== undefined ? data.risk_score_janela_carencia_dias : 60,
          risk_score_limite_critico: data.risk_score_limite_critico !== undefined ? data.risk_score_limite_critico : 50,
          riskScoreLimiteCritico: data.risk_score_limite_critico !== undefined ? data.risk_score_limite_critico : 50,
          habilitar_next_trip_engine: data.habilitar_next_trip_engine !== false,
          habilitarNextTripEngine: data.habilitar_next_trip_engine !== false,
          next_trip_corte_prontidao_alta: data.next_trip_corte_prontidao_alta !== undefined ? data.next_trip_corte_prontidao_alta : 75,
          nextTripCorteProntidaoAlta: data.next_trip_corte_prontidao_alta !== undefined ? data.next_trip_corte_prontidao_alta : 75,
          ...
          <form id="form-senha-admin" class="space-y-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input id="input-nova-senha" type="password" minlength="6" autocomplete="new-password" placeholder="••••••••" class="w-full px-3.5 py-2.5 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 text-slate-800 dark:text-slate-100 font-semibold" />
              </div>
              ...
              <div>
                ...
                <input id="input-confirmar-senha" type="password" minlength="6" autocomplete="new-password" placeholder="••••••••" class="w-full px-3.5 py-2.5 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 text-slate-800 dark:text-slate-100 font-semibold" />
              </div>
            </div>
