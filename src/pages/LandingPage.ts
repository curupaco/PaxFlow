  ...
  private render(): void {
    this.container.innerHTML = `
      <div class="landing-page-wrapper min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-indigo-500 selection:text-white flex flex-col relative overflow-hidden transition-colors duration-300">
        ...
        <!-- Testimonials / Social Proof Section (Humano e Profissional) -->
        <section class="w-full bg-slate-100/60 dark:bg-slate-950/40 py-20 px-6 relative z-10 border-t border-slate-200/50 dark:border-slate-900/50">
          <div class="max-w-6xl mx-auto space-y-12">
            <div class="text-center max-w-2xl mx-auto space-y-3">
              <span class="px-3 py-1 bg-indigo-500/10 text-indigo-650 dark:text-indigo-400 border border-indigo-500/20 text-[10px] font-black uppercase tracking-widest rounded-full">
                Experiência Real nas Agências
              </span>
              <h2 class="text-2xl sm:text-4xl font-black text-slate-800 dark:text-white tracking-tight">
                Tranquilidade para quem gere. Encantamento para quem viaja.
              </h2>
              <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 font-medium">
                Veja o impacto imediato do PaxFlow no dia a dia operacional de agências parceiras:
              </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <!-- Card 1 -->
              <div class="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-6 rounded-3xl space-y-4 shadow-sm flex flex-col justify-between hover:border-indigo-500/40 transition">
                <div class="space-y-3">
                  <div class="flex text-amber-400 text-xs">
                    ★★★★★
                  </div>
                  <p class="text-xs text-slate-600 dark:text-slate-300 font-medium leading-relaxed italic">
                    "O alerta preventivo de passaportes mudou nosso pós-venda. Zeramos qualquer risco de cliente barrado no embarque e nossos passageiros adoram receber o itinerário no celular com a cor da nossa agência."
                  </p>
                </div>
                <div class="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center gap-3">
                  ...
                  <div>
                    <strong class="block text-xs font-black text-slate-800 dark:text-white">Gestora de Agência VIP</strong>
                    <span class="block text-[9px] text-slate-400 font-bold uppercase">São Paulo / SP</span>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-6 rounded-3xl space-y-4 shadow-sm flex flex-col justify-between hover:border-indigo-500/40 transition">
                <div class="space-y-3">
                  ...
                  <p class="text-xs text-slate-600 dark:text-slate-300 font-medium leading-relaxed italic">
                    "Organizar a escala mensal de 12 consultores em planilhas era um pesadelo. No PaxFlow, os pedidos de troca e saldos de banco de folga são resolvidos em segundos com total aprovação da gestão."
                  </p>
                </div>
                <div class="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center gap-3">
                  <div class="w-8 h-8 rounded-full bg-emerald-600 text-white font-extrabold text-xs flex items-center justify-center">
                    OP
                  </div>
                  <div>
                    <strong class="block text-xs font-black text-slate-800 dark:text-white">Diretor de Operações</strong>
                    <span class="block text-[9px] text-slate-400 font-bold uppercase">Rio de Janeiro / RJ</span>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-6 rounded-3xl space-y-4 shadow-sm flex flex-col justify-between hover:border-indigo-500/40 transition">
                <div class="space-y-3">
                  ...
                  <p class="text-xs text-slate-600 dark:text-slate-300 font-medium leading-relaxed italic">
                    "O módulo de conciliação de reembolsos aéreos recuperou créditos que nem lembrávamos que existiam com as cias aéreas. O PaxFlow se pagou no primeiro mês de uso."
                  </p>
                </div>
                <div class="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center gap-3">
                  <div class="w-8 h-8 rounded-full bg-violet-600 text-white font-extrabold text-xs flex items-center justify-center">
                    FN
                  </div>
                  <div>
                    <strong class="block text-xs font-black text-slate-800 dark:text-white">Coordenadora Financeira</strong>
                    <span class="block text-[9px] text-slate-400 font-bold uppercase">Curitiba / PR</span>
                  </div>
                </div>
              </div>
