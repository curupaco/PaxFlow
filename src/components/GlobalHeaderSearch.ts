...
export class GlobalHeaderSearch {
  ...
  private render(): void {
    ...
    const html = `
      <header id="global-header-bar" class="min-h-14 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800/80 px-4 md:px-6 pt-safe pb-2.5 flex items-center justify-between gap-4 shrink-0 z-40 sticky top-0">
