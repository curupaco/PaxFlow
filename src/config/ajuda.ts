...
export const HELP_ITEMS: HelpItem[] = [
  ...
  },
  {
    id: 'studio-propostas',
    modulo: 'processos',
    label: '✨ PaxFlow Studio™ — Roteiros & Propostas Digitais',
    description: 'Central de criação e revisão ágil de roteiros interativos, lâminas de propostas em PDF e links públicos de aprovação.',
    details: 'O **PaxFlow Studio™** é a ferramenta de ponta a ponta do PaxFlow para elaboração de propostas comerciais de alto impacto visual e operacional.\n\n### 🚀 Recursos Principais:\n1. **Extrator Inteligente de Reservas**: Extrai e preenche automaticamente trechos de voos, hotéis e vouchers a partir de PDFs ou textos colados de companhias aéreas e fornecedores.\n2. **Revisão 100% Editável**: Todos os campos (companhia aérea, voo, localizador, horários, hotel, regime, quarto, valores e notas) podem ser inspecionados e alterados livremente pelo consultor antes da emissão.\n3. **Lâminas em PDF de Alta Resolução**: Geração instantânea de PDFs profissionais com identidade visual da agência, tags de companhias aéreas e badges de localizador.\n4. **Link Interativo & Aceite Formal**: Compartilhamento de proposta web responsiva para o passageiro com opção de aprovação formal online e validade configurável.'
  }
];
