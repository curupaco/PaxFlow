-- ============================================================================
-- PAXFLOW - ATUALIZAÇÃO DA BUSCA GLOBAL (CO-PILOTO / BALCÃO - DATAS DE VIAGEM)
-- Data: 2026-09-16
-- Descrição:
--   Atualiza a função RPC 'buscar_balcao_co_piloto' para retornar as datas de ida
--   e volta (data_ida, data_volta) das viagens vinculadas, permitindo a correta
--   exibição do período no dropdown em tempo real da barra de busca global.
-- ============================================================================
