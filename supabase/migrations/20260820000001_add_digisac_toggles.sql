-- 1. Add feature toggle columns to global_settings_table if not exist
ALTER TABLE public.global_settings_table ADD COLUMN IF NOT EXISTS digisac_enable_manual_send BOOLEAN DEFAULT true;
ALTER TABLE public.global_settings_table ADD COLUMN IF NOT EXISTS digisac_enable_chat_history BOOLEAN DEFAULT true;
ALTER TABLE public.global_settings_table ADD COLUMN IF NOT EXISTS digisac_enable_vouchers BOOLEAN DEFAULT true;
ALTER TABLE public.global_settings_table ADD COLUMN IF NOT EXISTS digisac_enable_routing BOOLEAN DEFAULT true;
ALTER TABLE public.global_settings_table ADD COLUMN IF NOT EXISTS digisac_enable_bot_triggers BOOLEAN DEFAULT true;
ALTER TABLE public.global_settings_table ADD COLUMN IF NOT EXISTS digisac_enable_webhooks BOOLEAN DEFAULT true;
