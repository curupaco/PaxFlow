...
- **Calculadora Reativa & Barra de Status do Detalhamento Financeiro [NEW]** — Indicador visual de percentual e barra de progresso no formulário de produtos da viagem, calculando em tempo real a conciliação entre Venda e o rateio de Tarifa + Taxas + Comissão + Markup + RAV, acompanhado de feedback visual inline com animação verde no botão Salvar.
