...
- **Next Trip Engine™ (Motor Preditivo de Recompra & Ciclo de Vida do Viajante) [NEW / EM BREVE]** — Inteligência comercial preditiva que analisa o histórico de viagens, destinos anteriores, notas de NPS, ticket médio e sazonalidade para responder: *"Quais clientes da agência estão no momento ideal para comprar uma nova viagem?"*. Apresenta pontuação de prontidão (0 a 100) baseada em 5 vetores estratégicos, agrupamento por *Clusters de Afinidade* (Europa 12m, Resorts no Verão, Disney/Família, Aniversário de Viagem), ações de 1-Clique (*Criar Orçamento Preditivo* e *Disparar WhatsApp Personalizado*), ciclo de engajamento *"Em Abordagem"* com snooze automático de 30 dias, agrupamento por titular da família/grupo e 4 modelos padrão nativos de WhatsApp.
